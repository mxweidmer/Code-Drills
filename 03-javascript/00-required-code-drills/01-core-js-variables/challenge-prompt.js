...
var statementOne = subject + ": " + firstName + " " + lastName + " is a " + nationality + " " + profession + " born in " + birthYear + "."
...
// much like you did for the console logs and `fullName`
var statementThree = "In " + yearOfPublish + " she published the first Algorithm, the " + firstAlgorithm + " at the age of " + ageAtYearOfPublish;
